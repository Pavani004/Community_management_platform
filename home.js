$(".header-search input").on("focus", function () {
  ...
  $(document).on("click", ".photo-grid .grid", function () {
    openLightbox($("img", this).attr("src"));
  });
  
  $(".lightbox i,body").on("click", function () {
    closeLightbox();
  });
      ...
      var self = this,
        onEndTransitionFn = function (ev) {
          ...
          if (support.transitions) {
            ...
            if (
              (self.expanded && ev.propertyName !== "opacity") ||
              (!self.expanded &&
  ...
  (function () {
    ...
    function noScrollFn() {
      window.scrollTo(
        scrollPosition ? scrollPosition.x : 0,
    ...
    [].slice
      .call(document.querySelectorAll(".morph-button"))
    ...
    [].slice
      .call(document.querySelectorAll("form button"))
      .forEach(function (bttn) {
